...
export class MedAuthorityComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMedAuthority): number => this.medAuthorityService.getMedAuthorityIdentifier(item);
  ...
  delete(medAuthority: IMedAuthority): void {
    const modalRef = this.modalService.open(MedAuthorityDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.medAuthority = medAuthority;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.medAuthorities = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMedAuthority[] | null): IMedAuthority[] {
    return data ?? [];
  }
