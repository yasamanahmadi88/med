...
export class LogsComponent implements OnInit {
  ...
  constructor(
    protected logReportService: LogReportService,
  ...
  trackId = (_index: number, item: IReportLogs): number => this.logReportService.getLogIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.logs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IReportLogs[] | null): IReportLogs[] {
    return data ?? [];
  }
