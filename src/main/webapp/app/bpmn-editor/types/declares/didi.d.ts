declare module 'didi' {
  ...
  export type InitializerFunction = ((...args: any[]) => unknown) & Annotated;

  export type FactoryFunction<T> = ((...args: any[]) => T) & Annotated;

  export type ArrayArgs<T> = [...string[], T];

  export type ServiceProvider<T> = (name: string) => T;
