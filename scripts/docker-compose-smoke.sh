...
export SECURITY_AUTHENTICATION_JWT_BASE64_SECRET="${SECURITY_AUTHENTICATION_JWT_BASE64_SECRET:-${JHIPSTER_SECURITY_AUTHENTICATION_JWT_BASE64_SECRET:-bXktc2VjcmV0LWtleS13aGljaC1zaG91bGQtYmUtYXQtbGVhc3QtNjQtY2hhcmFjdGVycy1sb25nLWZvci1ocy01MTI=}}"
export JHIPSTER_SECURITY_AUTHENTICATION_JWT_BASE64_SECRET="${JHIPSTER_SECURITY_AUTHENTICATION_JWT_BASE64_SECRET:-$SECURITY_AUTHENTICATION_JWT_BASE64_SECRET}"
