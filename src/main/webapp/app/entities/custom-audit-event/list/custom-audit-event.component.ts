...
export class CustomAuditEventComponent implements OnInit {
  ...
  delete(customAuditEvent: ICustomAuditEvent): void {
    const modalRef = this.modalService.open(CustomAuditEventDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.customAuditEvent = customAuditEvent;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.customAuditEvents = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICustomAuditEvent[] | null): ICustomAuditEvent[] {
    return data ?? [];
  }
