...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../flow.test-samples';

import { FlowService } from './flow.service';

const requireRestSample: IFlow = {
...
describe('Flow Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Flow', () => {
      ...
      service.create(flow).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Flow', () => {
      const flow = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(flow).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addFlowToCollectionIfMissing', () => {
      it('should add a Flow to an empty array', () => {
        const flow: IFlow = sampleWithRequiredData;
      ...
      it("should add a Flow to an array that doesn't contain it", () => {
        const flow: IFlow = sampleWithRequiredData;
        const flowCollection: IFlow[] = [sampleWithPartialData];
        expectedResult = service.addFlowToCollectionIfMissing(flowCollection, flow);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(flow);
      });
      ...
      it('should add only unique Flow to an array', () => {
        const flowArray: IFlow[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const flowCollection: IFlow[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const flow: IFlow = sampleWithRequiredData;
        const flow2: IFlow = sampleWithPartialData;
    ...
    describe('compareFlow', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareFlow(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareFlow(entity1, entity2);
        const compareResult2 = service.compareFlow(entity2, entity1);
