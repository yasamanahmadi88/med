 ...
 */
public interface CustomAuditEventRepository extends JpaRepository<CustomAuditEventEntity, Long> {
    ...
    List<CustomAuditEventEntity> findByPrincipalAndAuditEventDateAfterAndAuditEventType(String principal, Instant after, String type);

    Page<CustomAuditEventEntity> findAllByAuditEventDateBetween(LocalDateTime fromDate, LocalDateTime toDate, Pageable pageable);

    List<CustomAuditEventEntity> findByAuditEventDateBefore(Instant before);
}
