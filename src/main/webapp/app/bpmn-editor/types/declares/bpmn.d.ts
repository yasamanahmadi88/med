...
declare module 'bpmn-js/lib/draw/BpmnRenderer' {
  ...
  export type RendererHandler = <E extends Base, T extends SVGElement>(parentGfx: SVGElement, element: E, options?: any) => SVGElement;
...
declare module 'bpmn-js/lib/import/Importer' {
  ...
  export function importBpmnDiagram(diagram: Diagram, definitions: ModdleElement, bpmnDiagram: ModdleElement): Promise<DoneCallbackOpt>;
}
//
...
declare module 'bpmn-js/lib/features/modeling/Modeling' {
  ...
  export default class Modeling extends BaseModeling {
    constructor(eventBus: EventBus, elementFactory: ElementFactory, commandStack: CommandStack, bpmnRules: Rules);
...
declare module 'bpmn-js/lib/features/modeling/BpmnUpdater' {
  ...
  export default class BpmnUpdater extends CommandInterceptor {
    constructor(eventBus: EventBus, bpmnFactory: BpmnFactory, connectionDocking: ConnectionDocking, translate: Translate);
    ...
    updateFlowNodeRefs(businessObject: ModdleElement, newContainment: ModdleElement | Base, oldContainment: ModdleElement | Base): void;
    ...
    updateSemanticParent(businessObject: ModdleElement, newParent: Shape, visualParent?: ModdleElement): void;
...
declare module 'bpmn-js/lib/features/label-editing/LabelEditingPreview' {
  ...
  export default class LabelEditingPreview extends ModuleConstructor {
    constructor(eventBus: EventBus, canvas: Canvas, elementRegistry: ElementRegistry, pathMap: PathMap);
  }
}
//
...
declare module 'bpmn-js/lib/features/replace/BpmnReplace' {
  ...
  export const CUSTOM_PROPERTIES: ['cancelActivity', 'instantiate', 'eventGatewayType', 'triggeredByEvent', 'isInterrupting'];
...
declare module 'bpmn-js/lib/draw/bpmnRenderUtil' {
  ...
  export function isTypedEvent(event, eventDefinitionType: string, filter: object | unknown[]): boolean;
