...
class EnhancementPaletteProvider extends PaletteProvider {
  ...
  getPaletteEntries() {
    ...
    function createSqlTask(event: any) {
    ...
    // }
    function createKafkaTransmitterModule(event: any) {
    ...
    function createKafkaReceiverModule(event: any) {
    ...
    function createHttpTransmitter(event: any) {
    ...
    function createEventaDbReceiver(event: any) {
